...
function twentyseventeen_setup() {
  ...
  if (is_category()) {
	...
	$newtitle = str_replace( 'Howdy', 'Hey', $my_account->title );
  ...
  function table_of_contents() {
   register_sidebar(
       array (
           'name' => __( 'Table of Contents', 'coachstyleguide' ),
           'id' => 'table-of-contents',
           'description' => __( 'Table of Contents', 'coachstyleguide' ),
...
add_action( 'widgets_init', 'table_of_contents' );
